...
const App = () => {
  return (
    <div className="relative min-h-screen bg-gradient-to-r from-purple-900 via-gray-900 to-black text-white">
      <div className="absolute inset-0 bg-[url('https://www.toptal.com/designers/subtlepatterns/patterns/dot-grid.png')] opacity-10"></div>

      <div className="relative py-[6%] z-10 flex flex-col items-center justify-center h-full text-center">
        <h1 className="text-7xl font-extrabold mb-4">React Tled</h1>
        <p className="my-2 px-40 font-mono font-bold">
          Setting up a React project is straightforward and efficient, thanks to
          tools like Create React App (CRA) or Vite. These tools provide a
          pre-configured environment to kickstart development without needing to
          configure Webpack or Babel manually.
        </p>
        <div className="flex items-center select-none">
          ...
          <img
            className="w-52"
            src="https://reactive-starter.vercel.app/logo.png"
            alt=""
          />
          <div className="bg-white rounded-full p-3 h-16 w-16 flex justify-center items-center">
            <img
              className="w-20 "
