...
const StickyIcon = () => {
    ...
    return (
        <div className="fixed bottom-10 right-5 z-50">
            <div
                className={`flex items-center justify-center bg-blue-500 text-white p-2 rounded-full shadow-lg transition-all duration-300 ${isHovered ? 'w-16 h-16 bg-green-500' : 'w-14 h-14'
                    }`}
